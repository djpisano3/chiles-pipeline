...
# Imaging is quicker after  averaging by 2x in time & 4x in frequency
...
for ii in seq:
    ...
    wlog.write('<td><img src="plots/target_HI_spectrum_spw'+str(ii)+'.png"><br>\n')
    wlog.write('Noise in spw '+str(ii)+'= '+str(sigma[ii]*1e3)+' mJy</td>\n')
    wlog.write('</tr>\n')
wlog.write('</table>\n')
wlog.write('</li>')
wlog.write('<hr>\n')
